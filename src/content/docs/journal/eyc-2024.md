...
I recently moved to Denver for the summer, into a furnished apartment with my friend Lukas. This post is an inventory of the items I decided to bring. I went into this exercise hoping I would learn something about myself, but I hadn't anticipated the crisp overview of my interests that would emerge.

If you are on desktop you can see an outline on the right side of the screen, and on mobile you can click "On this page" to view the outline. Each category below has a picture and commentary on the items contained, and I end the post with some closing thoughts on the accumulation of stuff.
...
The "THANK YOU" bag is just for organizing the normal run items: shades from the great [Boulder Sports Recycler](https://www.bouldersportsrecycler.com/), sunscreen, handheld bottle, and earbuds. The green shoes are for trail running and the Salomon hydration vest is for longer runs.
...
Sometimes I consider quitting coffee to save money, but the social aspects keep me loyal. Also, the fact that I categorized coffee as a "daily ritual" here has shifted my perspective positively.
...
I've had a number of digital keyboards and none of them really stuck, so I shelled out for this Yamaha P125 with 88 weighted keys. It's still not the same as a real piano but it's good enough for me to enjoy and to keep up [my music writing](/music).
...
Many of my outer layers and athletic clothes were left out of this section and included in the [activity](#backpacking)-[specific](#climbing) [sections](#running) above instead.
...
I have spoken with my brother-in-law Netzach about how to harmoniously deal with old and unwanted things, and we agreed that there is no good way to do so and that the best approach is to not accumulate in the first place. Of course, this is in direct tension with my value to explore. I think the balance I'm striking right now is alright.
