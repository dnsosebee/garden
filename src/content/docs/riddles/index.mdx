...
Note: all the riddles are decently hard, but still it seems worthwhile to organize by difficulty, though it's highly subjective. So I have chosen a scale of "spiciness". This is a bit like one of those restaurants where the waiter will ask "Are you sure you want that? It's Thai spicy, not American spicy."

## All the approved riddles

New riddles are added to the top of the list.
...
- TODO: two doors to heaven and hell
- TODO: monty hall
- TODO: rubik's cube
...
- TODO: break an obtuse triangle into acute trianges
...
- TODO: 100 prisoners wearing hats
...
- TODO: 100 people in a line, 101 unique hats
